...
class Mahasiswa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nim, id_user, id_dosen, kode_pos, tahun_ayah, tahun_ibu, penghasilan', 'numerical', 'integerOnly'=>true),
			...
			array('id_mhs, nim, nama, id_user, id_dosen, jurusan, fakultas, jenjang, tanggal_lahir, tempat_lahir, status_nikah, no_telp, no_hp, email, tanggal_masuk, jenis_kelamin, kewarganegaraan, agama, alamat_rumah, alamat_tinggal, kode_pos, nama_ayah, tahun_ayah, nama_ibu, tahun_ibu, alamat_ortu, kode_pos_ortu, pddkan_ayah, pddkan_ibu, penghasilan, asal_sma, jurusan_sma, kota_kab, provinsi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'perkuliahans' => array(self::HAS_MANY, 'Perkuliahan', 'id_mhs'),
		);
	}
